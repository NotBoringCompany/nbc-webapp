...
const SignupSuccess = () => {
      ...
      if (email) {
        try {
          const response = await fetch(
            `https://nbc-webapp-api-ts-production.up.railway.app/webapp/check-if-verified/${email}`
          );
  ...
  return (
    <Layout
      ...
      description={
        errorMsg ? 'Invalid page' : 'Thank you for signing up on our web app!'
      }
    >
      <Flex
        direction='column'
        ...
        {!alreadyVerified && !errorMsg ? (
          <>
            ...
            <Flex direction='row' align='center' justify='center' w='50%'>
              ...
              >
                You have successfully created your account on our web app!{' '}
                <br />
                ...
                <br />
                <br />
                NOTE: If you haven&apos;t received any email from us within the
                next 24 hours, please contact support.
              </Text>
            </Flex>
          </>
        ) : (
