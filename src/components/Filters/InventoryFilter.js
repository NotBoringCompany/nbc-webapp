...
import { HeadingFour, HeadingSix } from '../Typography/Headings';
import { IconAdjustments, IconChevronDown, IconChevronUp } from '@tabler/icons';
      ...
      <Flex direction='column'>
        <Group mb='xs' grow>
          <Checkbox
            ...
            id='LuckBoost1'
            defaultChecked
            onClick={(e) => handleLuckBoostChange(e)}
            className={classes.checkboxStyle}
          />
          <Checkbox
            label='1.05'
