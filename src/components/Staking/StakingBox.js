import { Flex, Text, Select, SimpleGrid, Modal, Button, Box, createStyles, LoadingOverlay, Loader, ScrollArea } from '@mantine/core';
		...
		>
			...
			{stakingOngoing && stakingClosed && (
				...
				>
					...
					<Text c='#ca4242' size={20}>THIS STAKING POOL HAS ENDED.</Text>
				</Flex>
			)}
			{!stakingOngoing && !stakingClosed && (
				<>
